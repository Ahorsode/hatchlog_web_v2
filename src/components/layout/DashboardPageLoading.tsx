...
type DashboardPageLoadingProps = {
  /** Show a table-style main panel instead of a chart panel. */
  table?: boolean;
};

export function DashboardPageLoading({ table = false }: DashboardPageLoadingProps) {
  return (
    <div className="max-w-[1600px] mx-auto space-y-7 px-3 md:px-8 py-5 md:py-10 animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-7">
        <div
          className={`lg:col-span-2 bg-white/10 rounded-lg border border-white/10 backdrop-blur-md overflow-hidden p-7 space-y-5 ${
            table ? 'h-[600px]' : 'h-[500px]'
          }`}
        >
